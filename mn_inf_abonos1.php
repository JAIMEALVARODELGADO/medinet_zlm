                ...
                <div class="card text-left">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="titulo" name="titulo" size='200' value="INFORME DE ABONOS">
                            </div>
                        </div>
                        <div class="form-group row">
...
<script type="text/javascript">
    function actualizar(){
        ...
        if($('#fechaini').val()!=""){
            condicion+=" AND fecha_abono between '"+$('#fechaini').val()+"' AND '"+$('#fechafin').val()+"'";
        }
        //condicion=condicion.substring(5,200);
        $('#condicion').val(condicion);
        $('#sql').val("SELECT "+$('#campos').val()+" FROM vw_glosa_abono WHERE "+$('#condicion').val());         
        $(document).ready(function(){
            ...
            $("#tablaDatainforme").load("tablainf_abono.php");            
        });
    }

    function actcampos(){        
        var campos="numero_fac AS FACTURA,fecha_abono AS FECHA_ABONO,nombre_eps AS EPS,documento_abono AS DOCUMENTO,valorneto_fac AS VALOR_FACTURA,valor_abono AS VALOR_ABONO,dias_mora_abono AS DIAS_MORA,observacion_abono AS OBSERVACION,nombre_operador AS RESPONSABLE";
    ...
    function imprimir(){
        document.form1.action="mn_impr_informeabono.php";
